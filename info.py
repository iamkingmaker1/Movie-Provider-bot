...
auth_channel = environ.get('AUTH_CHANNEL', '-1002448002658 -1002493838247') #Channel / Group Id for force sub ( make sure bot is admin )
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/How_To_Open_Links_by') # How to open tutorial link for verification
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002407198965'))
